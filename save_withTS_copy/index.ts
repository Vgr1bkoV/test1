...
function wictoryScreen2(container:HTMLElement) {
  clearInterval(intervalId);
  const background = document.createElement("div");
  background.classList.add("res-background");
...
function wictoryScreen3(container:HTMLElement) {
  clearInterval(intervalId);
  const background = document.createElement("div");
  background.classList.add("res-background");
...
function defeatScreen2(container:HTMLElement) {
  clearInterval(intervalId);
  const background = document.createElement("div");
  background.classList.add("res-background");
...
function defeatScreen3(container:HTMLElement) {
  clearInterval(intervalId);
  const background = document.createElement("div");
  background.classList.add("res-background");
